                ...
                <div className="footer-bottom-new">
                    <div className="footer-bottom-content">
                        ...
                        <div className="footer-bottom-links">
                            <a href="/privacy-policy" className="bottom-link">Privacy Policy</a> <span style={{marginRight: '20px' , color: 'gray',marginLeft: '10px'}}>|</span>
                            <a href="/refund-policy" className="bottom-link">Refund Policy</a> <span style={{marginRight: '20px' , color: 'gray',marginLeft: '10px'}}>|</span>
                            <a href="/terms-conditions" className="bottom-link">Terms & Conditions</a>
                        </div>
